'''
This version creates an explicit time series for each sample, using the new variable layout, from TC data dated since 2008.
...
def main():
    ...
    data_best_track = data_best_track.query("(SEASON >= 2008)")
    if verbose:
    ...
    # write to file
    output_pandas_to_file(dataset, "baseline_dataset_tsnv_2008_{0}.gz".format(past_track_limit))
